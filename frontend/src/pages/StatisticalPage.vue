<template>
  <div class="grid grid-cols-3">
    <div class="col-span-1">
      <div class="mb-8 pl-4">
        <h2 class="text-2xl mb-4 font-semibold">Confirmed Orders</h2>
    ...
    <div class="mb-8 ml-4 col-span-2">
      <h2 class="text-2xl font-semibold mb-4">Product statistics</h2>
      <div v-if="confirmedOrders.length === 0">No confirmed orders.</div>
      <div v-else>
        <button
          @click="exportToExcel"
        ...
        <table class="p-2 border rounded-md mt-4">
          <thead>
            <tr class="border-2 border-black font-bold">
              <th class="border-2 border-black p-2">Product Name</th>
              <th class="border-2 border-black p-2 text-center">
                Quantity Sold
              </th>
              <th class="border-2 border-black p-2 text-right">Total Price</th>
              <th class="border-2 border-black p-2 text-center">
                Inventory number
              </th>
            </tr>
